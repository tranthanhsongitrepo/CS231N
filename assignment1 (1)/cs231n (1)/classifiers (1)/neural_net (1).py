...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        # correct_scores = np.exp(a2[np.arange(a2.shape[0]), y])
        # print(y.shape)
        # print(N, 3)
        # scores = np.sum(-np.log(correct_scores / np.sum(scores, axis=1))) / a2.shape[0]
        ...
        loss = np.sum(-np.log(correct_scores / np.sum(scores, axis=1))) / \
            scores.shape[0] + reg * np.sum(W1 * W1) + reg * np.sum(W2 * W2)
    ...
    def train(self, X, y, X_val, y_val,
        ...
        for it in range(num_iters):
            ...
            #########################################################################
            # *****START OF YOUR CODE (DO NOT D1LETE/MODIFY THIS LINE)*****

            t = learning_rate / X.shape[0]
            self.params['W1'] -= t * grads['W1']
            self.params['W2'] -= t * grads['W2']
            self.params['b1'] -= t * grads['b1']
            self.params['b2'] -= t * grads['b2']
